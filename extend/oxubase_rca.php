 ...
 */
class oxubase_rca extends oxubase_rca_parent
{
    public function getRandomArticle($sCatId, $blFullCatTree = null)
    {
        if ($sCatId)
        {
    ...
    public function getRandomCategoryArticles($sCatId, $iAmount = 1, $blFullCatTree = null)
    {
        if ($sCatId)
        {
            /** @var oxArticleList $oList */
