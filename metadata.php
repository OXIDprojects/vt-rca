...
$aModule = array(
    ...
    'extend'      => array(
        ...
        'manufacturerlist' => 'vt-rca/extend/manufacturerlist_nca',
        'start'            => 'vt-rca/extend/start_nca',
        'details'          => 'vt-rca/extend/details_nca',
        'oxarticlelist'    => 'vt-rca/extend/oxarticlelist_nca',*/
    ),
    ...
    'blocks'      => array(
        //array('template' => 'page/list/list.tpl', 'block' => 'category_newestarticles', 'file' => '/views/blocks/category_newestarticles.tpl')
    )
);